...
public class AccountDaoImpl implements AccountDao {
    ...
    public AccountDaoImpl() {
        ...
        Account account1 = new Account("prepaid", "Hritika", 500);
        accountEntry.put("8920111985", account1);
        Account account2 = new Account("prepaid", "Megha", 450);
        accountEntry.put("9823920123", account2);
        Account account3 = new Account("prepaid", "Rajat", 631);
        accountEntry.put("9932012345", account3);
        Account account4 = new Account("prepaid", "Vikas", 521);
        accountEntry.put("9010210131", account4);
        Account account5 = new Account("prepaid", "Satish", 632);
